                    ...
                    <div className="-mx-4 flex flex-wrap justify-between">
                        ...
                        <div className="px-4 my-4 w-full sm:w-auto xl:w-1/5">
                            ...
                            <div className="flex space-x-2">
                                {/* facebook */}
                                <Link to="https://www.facebook.com/profile.php?id=61573913908015" className="h-8 w-8 border border-gray-100 rounded-full flex items-center justify-center hover:text-blue-400 hover:border-blue-400"
                                  target="_blank"
                                ...
                                {/* twitter */}
                                <Link to="https://x.com/agilityai564" className="h-8 w-8 border border-gray-100 rounded-full flex items-center justify-center hover:text-blue-400 hover:border-blue-400"
                                  target="_blank"
                                  rel="noopener noreferrer">
                                ...
                                {/* linkedin */}
                                <Link to="https://www.linkedin.com/company/agility-ai-pvt-ltd/" className="h-8 w-8 border border-gray-100 rounded-full flex items-center justify-center hover:text-blue-400 hover:border-blue-400"
                                  target="_blank"
                                  rel="noopener noreferrer">
                                ...
                                {/* Instagram */}
                                <Link to="https://www.instagram.com/agilityy.ai?igsh=MXAxZnRuZG9kZXE0eQ==" className="h-8 w-8 border border-gray-100 rounded-full flex items-center justify-center hover:text-blue-400 hover:border-blue-400"
                                  target="_blank"
                                  rel="noopener noreferrer">
                                    <svg className="w-4 h-4 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
